...
export default () => {
  return (
    <Wrapper label="Form" time="-">
      <Accordion.Container>
        <Accordion title="Form 表单">
          <FormWrapper />
          <Description>
            [2020-09-28]
            Ant-Design4的Form组件依赖库rc-field-form的一层封装，可以自定义表单域的样式以及报错信息。
          </Description>
        </Accordion>

        <Accordion title="Slider 滑动条">
          <Part>滑动条</Part>
        ...
        <Accordion title="Input 输入框">
          ...
          />
          <Description>
            [2020-09-17] 模仿 Material Design 的
            Input组件，主要使用CSS动画实现。
          </Description>
        </Accordion>
        <Accordion title="Switch 开关">
          <Part>开关</Part>
          <Switch />
